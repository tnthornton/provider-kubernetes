...
import (
	...
	scv1alpha1 "github.com/crossplane-contrib/provider-kubernetes/apis/v1alpha1"
	k8s "github.com/crossplane-contrib/provider-kubernetes/internal/controller"
	"github.com/crossplane-contrib/provider-kubernetes/pkg/features"
)
...
func main() {
	...
	kingpin.FatalIfError(k8s.Setup(mgr, o), "Cannot setup Template controllers")
